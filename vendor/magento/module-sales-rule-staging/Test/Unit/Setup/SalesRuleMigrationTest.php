...
class SalesRuleMigrationTest extends TestCase
{
    ...
    {
        $this->updateRepository = $this->getMockBuilder(
        ...
        $this->updateFactory = $this->getMockBuilder(
            ...
            ->getMock();
        $this->ruleFactory = $this->getMockBuilder(
            RuleFactory::class
        )->onlyMethods(
            ['create',]
        )->disableOriginalConstructor()
        ...
        $logger = $this->getMockBuilder(
            ...
            ->getMockForAbstractClass();
        $this->versionManagerFactory = $this->getMockBuilder(
            VersionManagerFactory::class
        )->onlyMethods(
            ['create',]
        )->disableOriginalConstructor()
            ->getMock();
        $this->createEntityVersion = $this->getMockBuilder(
            CreateEntityVersion::class
        )->onlyMethods(
            ['execute',]
        )->disableOriginalConstructor()
            ->getMock();
        $this->updateEntityVersion = $this->getMockBuilder(
            UpdateEntityVersion::class
        )->onlyMethods(
            ['execute',]
        )->disableOriginalConstructor()
            ->getMock();
